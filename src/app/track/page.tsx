  ...
  return (
    <main className="min-h-screen bg-[#f5f6fa] flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-3xl bg-white shadow-xl border border-gray-100 p-8 text-center">
        ...
        <h1 className="text-xl font-bold text-gray-900">Geçersiz Takip Bağlantısı</h1>
        <p className="mt-3 text-sm text-gray-500 leading-relaxed">
          Bu sayfa geçerli bir mağaza bağlantısı içermiyor. Lütfen mağazanın size sağladığı özel takip bağlantısını kullanın.
        </p>
        <p className="mt-4 text-xs text-gray-400">
          Doğru bağlantı genellikle şu formattadır:<br />
          <code className="font-mono text-gray-600">/track/[mağaza-kodu]</code>
        </p>
      </div>
    </main>
  );
